            ...
            <div className="container-fluid">
                ...
                <div className="rss-about__timeline-section">
                    <div className="rss-about__timeline-section__heading-container">
                        <h2 className="rss-about__timeline-section__heading-container__title font-28-48">Milestones of My Career</h2>
                        <p className="rss-about__timeline-section__heading-container__content font-14-18">Lorem ipsum dolor sit amet consectetur. Nisl ut neque tortor nulla felis nunc. Sit ac sed sed pulvinar sit purus morbi. Elit amet sed velit auctor urna vitae nam ultricies massa.</p>
                    </div>
                    <div className="rss-about__timeline-section__content-container">
                        ...
                        <h6 className="rss-about__timeline-section__content-container__title font-16-20">Expanding Horizons</h6>
                        <div className="rss-about__timeline-section__content-container__line-styled" />
                        <div className="rss-about__timeline-section__content-container__details-container-right">
                        ...
                        <div className="rss-about__timeline-section__content-container__line rss-about__timeline-section__content-container__line-green" />
                        <h6 className="rss-about__timeline-section__content-container__title font-16-20">A Collaborative Partnership</h6>
                        ...
                        <div className="rss-about__timeline-section__content-container__details-container-left">
                        ...
                        <p className="rss-about__timeline-section__content-container__time font-16-20">2021</p>
                        <div className="rss-about__timeline-section__content-container__line rss-about__timeline-section__content-container__line-yellow" />
                        <h6 className="rss-about__timeline-section__content-container__title font-16-20">Entrepreneurial Pursuits</h6>
                        ...
                        <p className="rss-about__timeline-section__content-container__time font-16-20">2020</p>
                        <div className="rss-about__timeline-section__content-container__line rss-about__timeline-section__content-container__line-orange" />
                        <h6 className="rss-about__timeline-section__content-container__title font-16-20">A Corporate Adventure</h6>
                        ...
                        <p className="rss-about__timeline-section__content-container__time font-16-20">2019</p>
                        <div className="rss-about__timeline-section__content-container__line rss-about__timeline-section__content-container__line-pink" />
                        <h6 className="rss-about__timeline-section__content-container__title font-16-20">Learning and Growing</h6>
                        ...
                        <div className="rss-about__timeline-section__content-container__line rss-about__timeline-section__content-container__line-blue" />
                        <h6 className="rss-about__timeline-section__content-container__title font-16-20">A World of Possibilities in 2018</h6>
