        ...
        <>
            ...
            <section className="rss-contact">
                <div className="container-fluid">
                    ...
                    <Banner iconPath={`${import.meta.env.BASE_URL}icons/chat-ico.png`} iconAlt="Chat Icon" contentTitle="We'd love to here from you" contentSlug="Reach out — I’m excited to hear what you’re working on">
